...
const TOPIC_RULES: Record<string, Partial<TopicRule>> = {
  ...
  'Number Series':         { minPYQs: 10, accuracyGate: 75, conceptHours: 1,   topperTips: ['🏆 Most common patterns: AP, GP, squares, prime numbers', '⚡ Check differences first — most KSP series are AP or square-based', '📐 In 45 seconds: scan for constant diff, ratio, then complex patterns'] },
