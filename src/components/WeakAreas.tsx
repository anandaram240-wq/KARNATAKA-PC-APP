...
const SUBJECT_META: Record<string, { icon: string; color: string; bg: string; border: string }> = {
  'Mathematics':       { icon: '📐', color: 'text-blue-400',   bg: 'bg-blue-950/20',   border: 'border-blue-500/20' },
  'Reasoning':         { icon: '🧩', color: 'text-purple-400', bg: 'bg-purple-950/20', border: 'border-purple-500/20' },
  'General Science':   { icon: '🔬', color: 'text-emerald-400',bg: 'bg-emerald-950/20',border: 'border-emerald-500/20' },
  'General Awareness': { icon: '🌍', color: 'text-amber-400',  bg: 'bg-amber-950/20',  border: 'border-amber-500/20' },
};
